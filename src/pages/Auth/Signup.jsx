...
export default function Signup() {
    ...
    async function handleGoogleSignup() {
        try {
            ...
            // For Google Signup, we fetch the doc to see if onboarding is completed
            // (in case they already had an account and clicked 'Google' from signup page)
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center items-center px-container-margin py-section-gap relative z-10">
                ...
                <div className="w-full max-w-md space-y-8 bg-surface-container-lowest/90 backdrop-blur-2xl p-card-padding rounded-xl border border-white/5 shadow-[0_0_30px_rgba(16,185,129,0.05)] relative overflow-hidden">
                    ...
                    <div className="text-center md:text-left space-y-2">
                        <h1 className="font-headline-lg text-headline-lg-mobile md:text-headline-lg text-on-surface">Create an account</h1>
                        <p className="font-body-md text-body-md text-on-surface-variant">Join SpendWise AI to unlock obsidian intelligence.</p>
                    </div>
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        <div className="space-y-4">
                            ...
                            <div className="relative group">
                                ...
                                <input 
                                    className="appearance-none block w-full pl-10 pr-3 py-3 border border-white/10 bg-white/5 rounded-lg text-on-surface placeholder-on-surface-variant focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary transition-all font-body-md text-body-md" 
                                    id="password" name="password" placeholder="Password" required type="password" minLength="6"
                        ...
                        <div>
                            <button disabled={loading} className="group relative w-full flex justify-center py-3 px-4 border border-transparent rounded-lg text-white bg-primary-container hover:bg-primary-container/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary focus:ring-offset-background font-label-md text-label-md shadow-[0_4px_20px_rgba(16,185,129,0.3)] transition-all active:scale-[0.98] disabled:opacity-50" type="submit">
                                <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                                    <span className="material-symbols-outlined text-white/70 group-hover:text-white transition-colors">person_add</span>
                                </span>
                                Create Account
                            </button>
                        </div>
                    ...
                    <div className="mt-6">
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-2 bg-surface-container-lowest text-on-surface-variant font-label-sm text-label-sm">Or sign up with</span>
                            </div>
                        </div>
                        <div className="mt-6 grid grid-cols-2 gap-3">
                            <div>
                                <button onClick={handleGoogleSignup} disabled={loading} className="w-full flex justify-center items-center py-2 px-4 border border-white/10 rounded-lg shadow-sm bg-white/5 font-label-md text-label-md text-on-surface hover:bg-white/10 transition-colors">
                    ...
                    <p className="mt-8 text-center font-body-md text-body-md text-on-surface-variant">
                        ...
                        <Link className="font-label-md text-label-md text-primary hover:text-primary-fixed transition-colors ml-1" to="/login">Sign in</Link>
                    </p>
                </div>
            </div>
                ...
                <div className="relative z-10 flex flex-col justify-center items-start w-full h-full p-section-gap text-on-surface max-w-2xl mx-auto">
                    <div className="space-y-6 backdrop-blur-xl bg-surface-container-lowest/40 p-10 rounded-2xl border border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.5)]">
                        ...
                        <h2 className="font-display-lg text-display-lg font-bold leading-tight">
                            Your data, <br/>
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">fully protected.</span>
                        </h2>
                        <p className="font-body-lg text-body-lg text-on-surface-variant max-w-md">
                            We use bank-level encryption. Your financial data is anonymized before being processed by our neural engine.
                        </p>
                    </div>
                </div>
            </div>
